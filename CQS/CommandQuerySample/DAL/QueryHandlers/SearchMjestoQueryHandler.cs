...
public class SearchMjestoQueryHandler : IQueryHandler<SearchMjestoQuery, List<Contract.DTOs.Mjesto>>
{
  ...
  public async Task<List<Contract.DTOs.Mjesto>> Handle(SearchMjestoQuery query)
  {
