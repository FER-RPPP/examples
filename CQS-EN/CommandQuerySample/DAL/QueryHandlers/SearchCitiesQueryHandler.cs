...
public class SearchCitiesQueryHandler : IQueryHandler<SearchCitiesQuery, List<Contract.DTOs.City>>
{
  ...
  public async Task<List<Contract.DTOs.City>> Handle(SearchCitiesQuery query)
  {
