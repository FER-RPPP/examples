...
public class SearchCitiesQueryHandler : IRequestHandler<SearchCitiesQuery, IEnumerable<Contract.DTOs.City>>
{
  ...
  public async Task<IEnumerable<Contract.DTOs.City>> Handle(SearchCitiesQuery query, CancellationToken cancellationToken)
  {
